#ifndef _INCLUDE_GRAPHIC_CAMERA_H
#define _INCLUDE_GRAPHIC_CAMERA_H
...
struct Camera {
    ...
    void updateCameraVectors() {
      ...
      Right = glm::normalize(glm::cross(Front, WorldUp)); // normalize the vectors, because their length gets closer to 0 the more
